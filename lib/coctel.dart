class CoctelModel {
  ...
  CoctelModel({this.drinks});

  CoctelModel.fromJson(Map<String, dynamic> json) {
    if (json['drinks'] != null) {
...
class Drinks {
  ...
  Drinks.fromJson(Map<String, dynamic> json) {
    ...
    strMeasure1 =
        json['strMeasure1'] != null ? json['strMeasure1'] : "to taste";
    strMeasure2 =
        json['strMeasure2'] != null ? json['strMeasure2'] : "to taste";
    strMeasure3 =
        json['strMeasure3'] != null ? json['strMeasure3'] : "to taste";
    strMeasure4 =
        json['strMeasure4'] != null ? json['strMeasure4'] : "to taste";
    strMeasure5 =
        json['strMeasure5'] != null ? json['strMeasure5'] : "to taste";
    strMeasure6 =
        json['strMeasure6'] != null ? json['strMeasure6'] : "to taste";
    strMeasure7 =
        json['strMeasure7'] != null ? json['strMeasure7'] : "to taste";
    strMeasure8 =
        json['strMeasure8'] != null ? json['strMeasure8'] : "to taste";
    strMeasure9 =
        json['strMeasure9'] != null ? json['strMeasure9'] : "to taste";
    strMeasure10 =
        json['strMeasure10'] != null ? json['strMeasure10'] : "to taste";
    strMeasure11 =
        json['strMeasure11'] != null ? json['strMeasure11'] : "to taste";
    strMeasure12 =
        json['strMeasure12'] != null ? json['strMeasure12'] : "to taste";
    strMeasure13 =
        json['strMeasure13'] != null ? json['strMeasure13'] : "to taste";
    strMeasure14 =
        json['strMeasure14'] != null ? json['strMeasure14'] : "to taste";
    strMeasure15 =
        json['strMeasure15'] != null ? json['strMeasure15'] : "to taste";
